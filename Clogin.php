...
<!--<style>
	div {
		background-image: url('Consultaion.jpg');
	}
</style>-->	
<title> Justify Consultation Form </title>
<!-- Meta tags -->
...
<!-- //Meta tags -->
<!-- font-awesome-icons -->
<link href="Ccss/font-awesome.css" rel="stylesheet"> 
<!-- //font-awesome-icons -->
<!-- Stylesheet -->
<link href="Ccss/style1.css" rel='stylesheet' type='text/css' />
<!-- //Stylesheet -->
<!--fonts--> 
...
<body background="C:\Users\noman khan\Desktop\Website\web\images">
<!--background-->
<h1> <span>J</span>ustify <span>C</span>onsultation <span>F</span>orm </h1>
<div class="myclass1">

<h1> LOGIN </h1>
<p><br><b>Enter your details correctly:-</b></p>
<br><br>
<div class="text">

    <form action="Cauthenticate.php" method="POST">
        <table>
            <tr>       
                <td>Email Id :-</td>
            ...
            <br>
            <b><input type="submit" name="create" value="Login"></b>
            <br>
			<p style="text-align: center;">Not Registred yet ? <a href="Cregistration.php">Click Here</a>
</form> 
		</div>
   </div>
  <!--copyright-->

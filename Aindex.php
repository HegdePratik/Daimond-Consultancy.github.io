				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="link-effect-2" id="link-effect-2">
						<ul class="nav navbar-nav">
							<li><a href="Aindrx.php" class="effect-3" style="font-size: 125%;">Home</a></li>
							<li><a href="ManageStudents.php" class="effect-3" style="font-size: 125%;">Student's</a></li>
              <li><a href="" class="effect-3" style="font-size: 125%;">Consultant's</a></li>
							<li><a href="" class="effect-3" style="font-size: 125%;">Fedback</a></li>	
...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto">
    ...
    line-height: 1.5em;
    letter-spacing: 1px;
    font-weight: 700;">ADMIN <span style="color: #efb312;">DETAILS</span></h1>
      ...
      <div class="p-4 lg:w-1/2">
        <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
          ...
          <div class="flex-grow sm:pl-8">
            <h2 class="title-font font-medium text-lg text-gray-900">PRATIK HEGDE</h2>
            <h3 class="text-gray-500 mb-3">Tasks</h3>
            <a href="ManageStudents.php">Manage Students<i class="fa fa-long-arrow-right" aria-hidden="true"></i></a><br>
            <a href="ManageConsultants.php">Manage Consultants<i class="fa fa-long-arrow-right" aria-hidden="true"></i></a><br>
            <a href="">Manage Feedback<i class="fa fa-long-arrow-right" aria-hidden="true"></i></a><br>
                <!--<div class="more click" style="color:black">
									<a href="">ACCEPT<i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
				</div>-->
  ...
  <div class="container px-5 py-24 mx-auto">
    ...
    line-height: 1.5em;
    letter-spacing: 1px;
    font-weight: 700;">OTHER <span style="color: #efb312;">ADMIN</span></h1>
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base"></p>
    </div>
    <div class="flex flex-wrap -m-4">
      <div class="p-4 lg:w-1/2">
        <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
          <img alt="team" class="flex-shrink-0 rounded-lg w-48 h-48 object-cover object-center sm:mb-0 mb-4" src="https://dummyimage.com/200x200">
          <div class="flex-grow sm:pl-8">
            <h2 class="title-font font-medium text-lg text-gray-900">NOMAN KHAN</h2>
      ...
      <div class="p-4 lg:w-1/2">
        <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
          ...
          <div class="flex-grow sm:pl-8">
            <h2 class="title-font font-medium text-lg text-gray-900">JENIL PATEL</h2>
            <h3 class="text-gray-500 mb-3"></h3>
            <p class="mb-4"></p>
            <span class="inline-flex">
              <a class="text-gray-500">
      ...
      <div class="p-4 lg:w-1/2">
        <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
          ...
          <div class="flex-grow sm:pl-8">
            <h2 class="title-font font-medium text-lg text-gray-900">DHIRAL VAGHELA</h2>
            <h3 class="text-gray-500 mb-3"></h3>
            <p class="mb-4"></p>
            <span class="inline-flex">
              <a class="text-gray-500">
        ...
        <div class="row">
         ...
         <div class="col-xs-6 col-md-3">
          ...
          <div class="col-xs-6 col-md-3" style="text-align:center;">
			...
			<li><a href="ManageStudents.php" class="effect-3">Messages</a></li>
            <li><a href="ManageConsultants.php" class="effect-3">Home</a></li>

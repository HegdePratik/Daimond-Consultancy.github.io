...
$query=mysqli_query($con,"update registration set full_name='$name' ,area_of_interest='$area_of_interest' , email='$email' mobile_number='$mobile_number' , password='$password' , result='$result' where sr_no='$sr_no'");
